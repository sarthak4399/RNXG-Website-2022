...
const About = () => {
  return (
    <div className=" text-center  max-W-[1240px] mx-auto py-16  bg-[#141414] ">
      ...
      <p className=" text-gray-200 py-4 text-xl text-center mx-auto justify-center w-[20rem] ">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-2  gap-4 md:grid-cols-2  py-5 px-[20px] justify-items-center ">
        <div className="flex flex-col border rounded-3xl text-left py-12 px-8 ring-1 ring-[#00df9a] ring-offset-0 w-[20rem] ">
          <div className="shadow-teal-300">
